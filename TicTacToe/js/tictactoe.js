...
//This function is placing an x or o in a square.
function placeXOrO(squareNumber) {
    //This condition ensures a square hasn't been selected already.
    //The .some() method is used to check each element of selectedSquare array
    //to see if it contains the square number clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This varaiable retrieves the html element id that was clicked on.
        let select = document.getElementById(squareNumber);
        //This condition checks who's turn it isl
        if (activePlayer === 'X') {
        ...
        if(activePlayer === 'O'){
            ...
            disableClick();
            //This function waits 1 second before computer places image and enables clickl
...
//This function parses the selectedSquares aray to search for win conditions.
...
function checkWinConditions() {
    ...
    // O 0, 4, 8 condition.
    else if (arrayIncludes('0O', '4O', '8O')) { drawWinLine(100, 100, 520, 320) }
